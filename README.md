...
Top.ZIndex = 2
	...
	Logo.Image = "rbxassetid://13214520023"
	Logo.Active = true
	Logo.ZIndex = 8
...
postog123.Color = Color3.fromRGB(0,255,0)
...
Yawa.Color = Color3.fromRGB(0,255,0)
...
function main:PlayerInfo()
			...
			function main:Dropdown(Name, list, default, callback)
                ...
                Main_Ui2Stroke.Color = Color3.fromRGB(0,255,0)
...
--]]
		...
		function main:Seperator(text)
			...
			Seperator.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
...
ImageButton1.Image = "http://www.roblox.com/asset/?id=13214520023"
...
Shop:Button("Random Race (Use 3K Fragments)", function()
    ...
    Misc:Button("Destroy Ui",function()
        if game.CoreGui:FindFirstChild("GRASS HUB") then
            game.CoreGui:FindFirstChild("GRASS HUB"):Destroy()
